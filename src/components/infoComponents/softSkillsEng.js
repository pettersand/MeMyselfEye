              ...
              <SkillContainer>
                ...
                <SkillDetails expanded={skillState.analytical}>
                  ...
                  <SkillItem>
                    Application:
                    <p>
                      Leveraging the analytical mindset honed through my
                      Master's in Exercise Science, I approach coding
                      systematically, and always aim at improving programming
                      solutions. This approach mirrors my use of performance
                      data as a personal trainer, always aiming for optimized,
              ...
              <SkillContainer>
                ...
                <SkillDetails expanded={skillState.problemSolver}>
                  <SkillItem>
                    Description:
                    <p>
                      Finding solutions to challenges, by analyzing the
                      situation and applying logical reasoning.
                    </p>
                  </SkillItem>
                  <SkillItem>
                    Application:
              ...
              <SkillContainer>
                ...
                <SkillDetails expanded={skillState.positive}>
                  <SkillItem>
                    Description:
                    <p>
                      Maintain an optimistic and constructive outlook, even
                      during set-backs or challenging situations.
                    </p>
                  </SkillItem>
                  <SkillItem>
                    Application:
                    <p>
                      In work and personal situations, I approach challenges
              ...
              <SkillContainer>
                ...
                <SkillDetails expanded={skillState.empathetic}>
                  ...
                  <SkillItem>
                    Application:
                    <p>
                      Recognizing and addressing the perspectives and emotions
                      of teammates ensures a harmonious work environment. This
                      deep-rooted empathy, evident through roles in personal
                      training and assisting students with special needs, equips
                      me to support and uplift colleagues, enhancing team
                      dynamics and project outcomes. Everyone deserves to be
                      seen and heard.
                    </p>
                  </SkillItem>
                </SkillDetails>
              ...
              <SkillContainer>
                ...
                <SkillDetails expanded={skillState.patient}>
                  <SkillItem>
                    Description:
                    <p>
                      Capacity to tolerate or endure difficulties without
              ...
              <SkillContainer>
                ...
                <SkillDetails expanded={skillState.communicative}>
                  ...
                  <SkillItem>
                    Application:
                    <p>
                      In software development, effective communication is key.
                      My emphasis on both speaking and listening guarantees that
                      project requirements are understood, mistakes are
                      minimized, and the entire team remains aligned and
              ...
              <SkillContainer>
                ...
                <SkillDetails expanded={skillState.amicable}>
                  <SkillItem>
                    Description:
                    <p>
                      Possessing a pleasant and agreeable nature, and the
                  ...
                  <SkillItem>
                    ...
                    <p>
                      ...
                      ensures smooth team dynamics. I prioritize creating
                      positive interactions, avoiding unnecessary tensions, and
                      ensuring that I contribute to a constructive and cohesive
                      work environment.
                    </p>
                  </SkillItem>
                </SkillDetails>
                ...
                <SkillDetails expanded={skillState.leadership}>
                  ...
                  <SkillItem>
                    ...
                    <p>
                      ...
                      leader should be accountable and take responsibility for
                      all mistakes, while simultaneously not taking the credit
                      for success. I prioritize the well-being and recognition
                      of my team members, ensuring they are valued and heard.
                    </p>
                  </SkillItem>
                </SkillDetails>
              </SkillContainer>
              ...
              <SkillContainer>
                ...
                <SkillDetails expanded={skillState.publicSpeaking}>
                  ...
                  <SkillItem>
                    Application:
                    <p>
                      With confidence and clarity, I engage audiences,
                      delivering messages in a way that ensures understanding. I
                      have always been comfortable in front of crowds, and have
                      extensive experience from public speaking from my work as
                      a personal trainer, be it in a group training setting, or
                      holding presentations for peers.
                    </p>
                  </SkillItem>
                </SkillDetails>
              </SkillContainer>
                ...
                <SkillDetails expanded={skillState.adaptive}>
                  ...
                  <SkillItem>
                    ...
                    <p>
                      ...
                      adapt, wearing different hats as the situation demands.
                ...
                <SkillDetails expanded={skillState.ambitious}>
                  <SkillItem>
                    ...
                    <p>
                      ...
                      pushing oneself to new heights and striving for
